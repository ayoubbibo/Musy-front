<template>
  ...
  <!-- <iframe src="https://www.youtube.com/embed/kDehTEEoFnE" width="50%" frameborder="100" width="1920" height="1080" allowfullscreen></iframe> -->
  <div class="wrapper">
    <div class="player">
      <div class="player__top">
        <div class="player-cover">
          
          <div v-if="toplay === undefined"> 
            <transition-group :name="transitionName" v-for="(track, index) in tracks" :key="index">
                <div class="player-cover__item" v-if="index === currentTrackIndex" :style="{ backgroundImage: `url(${track.cover})` }" :key="index"></div> 
            </transition-group>
          </div>
...
export default {
  ...
  data() {
  return {
  toplay : this.$route.query.toplay,
  content: "",
    tracks :[
    ],
    audio: null,
  ...
  beforeCreate() {  
    ...
    response => {
      ...
      if( this.toplay === undefined)
      {
        ...
        {
          if(this.tracks[i]._id == this.toplay )
          {
